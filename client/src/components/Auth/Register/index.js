...
const Register = ({history}) => {
	...
	const handleOnSubmit = (e) => {
		...
		handleUserRegistration(newUser).then((user)=>{
			console.log(`successfull full ${user}`);
      ...
      <article className="card-body">
			...
			<Alert isVisible={!!user}  />
 			<form name="register" onSubmit={handleOnSubmit}>
				...
				<div className="form-group">
					<Input.Radio name="gender" value={gender}label="Male" onChange={handleOnChange} />
					<Input.Radio name="gender" value={gender}label="Female" onChange={handleOnChange} />
				</div> 
				<div className="form-row">
